...
| :--- | :--- | :--- | :--- |
| **[AMA-KAMA](./strategies/ama-kama)** | **Dual_Adaptive** | Trends are identified by the interaction of two efficiency-adjusted moving averages ($$ER$$). The primary signal is filtered by a "Value" regime ($$RSI < 43$$). | **Production** <br> *(Robust, 35% Decay)* |
| **[SMI](./strategies/02-strategy-smi)** | **Momentum_Oscillator** | Uses the distance of the close relative to the midpoint of the high/low range to identify "cleaner" momentum inflection points than standard Stochastics. | **Benchmark** <br> *(Stable Baseline)* |

### Volatility Breakout

| Strategy ID | Logic Class | Mathematical Premise | Validation Status |
| :--- | :--- | :--- | :--- |
| **[MABW](./strategies/mabw)** | **Volatility_Expansion** | Based on Mandelbrot's clustering hypothesis. Identifies regime squeezes ($$\text{Width} \approx \text{LLV}$$) and enters on momentum breakouts. | <span style="color:red">**Rejected**</span> <br> *(100% Degradation)* |
