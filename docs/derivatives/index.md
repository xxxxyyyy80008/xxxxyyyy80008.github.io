...
|--|---------|----------------|--------|
|1| **Black-Scholes Option Pricing and Monte Carlo**  | Implements the classic Black-Scholes formula and Monte Carlo simulations for European options. |[Docs](/docs/derivatives/options-pricing/01_black_scholes_monte_carlo) , [Kaggle Notebook](https://www.kaggle.com/code/xxxxyyyy80008/black-scholes-option-pricing-and-monte-carlo/) , [Github Notebook](https://github.com/xxxxyyyy80008/Option-Pricing-and-Risk-Models/blob/main/notebooks/01_black_scholes_monte_carlo.ipynb)|
